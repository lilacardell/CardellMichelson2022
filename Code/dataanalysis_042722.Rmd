...
rm(maize_geo,maizeprices_042722)
...
12. Output figure: Dot plot of frequency of negative returns over time 
...
13. Plots for distribution of extreme harvest prices and returns (for seasonal returns) 
```{r output13,echo=FALSE}
...
14. OLS and probit regressions on harvest price (real)
```{r regr ,echo=FALSE}
...
print(t,file=paste0(table_dir,"/OLSprobitreturns_single.tex"),include.rownames=FALSE)
...
print(t_fe,file=paste0(table_dir,"/OLSprobitreturns_FE_single.tex"),include.rownames=FALSE)
...
15.Analysis and output: Risk premium/certainty equivalent over seasonal returns 
```{r riskr, echo=FALSE}
...
print(sim_table_grp,file=paste0(table_dir,"/nostore_riskgrp.tex"),include.rownames=FALSE)

sim_table_grp=xtable(nostore_r0,auto=TRUE,type="latex")
print(sim_table_grp,file=paste0(table_dir,"/nostore_riskgrp_r.tex"),include.rownames=FALSE)

sim_table_grp=xtable(nostore_r5,auto=TRUE,type="latex")
print(sim_table_grp,file=paste0(table_dir,"/nostore_i5_riskgrp.tex"),include.rownames=FALSE)

sim_table_grp=xtable(nostore_r10,auto=TRUE,type="latex")
print(sim_table_grp,file=paste0(table_dir,"/nostore_i10_riskgrp.tex"),include.rownames=FALSE)

sim_table_grp=xtable(minr_nostore,auto=TRUE,type="latex")
print(sim_table_grp,file=paste0(table_dir,"/nostore_minr_riskgrp.tex"),include.rownames=FALSE)
...
16. Make nominal dataset and repeat analysis
```{r risknom,echo=FALSE}
...
print(sim_table_grp,file=paste0(table_dir,"/nostore_riskgrp_nom.tex"),include.rownames=FALSE)

sim_table_grp=xtable(nostore_r0n,auto=TRUE,type="latex")
print(sim_table_grp,file=paste0(table_dir,"/nostore_riskgrp_r_nom.tex"),include.rownames=FALSE)

sim_table_grp=xtable(nostore_r5n,auto=TRUE,type="latex")
print(sim_table_grp,file=paste0(table_dir,"/nostore_i_riskgrp_nom.tex"),include.rownames=FALSE)
...
17. Predicted lean season price and certainty equivalent/risk aversion 
```{r predrisk,echo=FALSE}
...
print(table_grp,file=paste0(table_dir,"/nostore_pred_i5.tex"),include.rownames=FALSE)
...
17. Predicted lean season price and certainty equivalent/risk aversion using nominal prices 
```{r predrisknom,echo=FALSE}
...
table_grp=xtable(nostore_r5,auto=TRUE,type="latex")
print(table_grp,file=paste0(table_dir,"/nostore_pred_nom_i5.tex"),include.rownames=FALSE)
