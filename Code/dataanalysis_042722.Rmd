...
pacman::p_load(data.table,tidyr,plyr,dplyr,readxl,haven,janitor,stringr,lubridate,foreign,stargazer,survey,xtable,fuzzyjoin,
               ...
               magrittr,labelled,stringdist,fixest,tidygeocoder,BBmisc,blorr,DescTools,tseries,kableExtra)
pacman::p_update()
...
0. Import dataset and combine with producer prices
```{r import0,include=FALSE,warning=FALSE}
...
maize_prices<-read_dta("./Data/Clean Data/maizegeoprices_042722.dta")
prod_prices<-read_dta("./Data/Clean Data/prod_prices_131221.dta")
cropdata<-read_dta("./Data/Clean Data/cropdata_042722.dta")
seasons<-read_dta("./Data/Clean Data/seasons.dta")%>%mutate(country=revalue(country,c("Swaziland"="Eswatini","Cape Verde"="Cabo Verde")))


allprices<-full_join(maize_prices,prod_prices,by=c("country","market","market_type","commodity","year","month"))

missingcpi=maize_prices%>%#3096 observations from Somalia and a few from South Sudan
...
rm(missingcpi,maize_prices)

```



1. Look at measures of skewness and kurtosis 
```{r skew1,echo=FALSE}
...
print(print,file=paste0("C:/Users/lilac2/Box/GIEWS_Project/GIEWS/Final/Output/skew_retail_",format(Sys.Date(),"%m_%d_%y"),".tex"),include.rownames=FALSE)

print=xtable(skew_wholesale,type="latex")
names(print)<-c("Country","Commodity","Markets","CV","Average Market Skewness ","Percent Markets Negative Skew")
print(print,file=paste0("C:/Users/lilac2/Box/GIEWS_Project/GIEWS/Final/Output/skew_wholesale_",format(Sys.Date(),"%m_%d_%y"),".tex"),include.rownames=FALSE)
...
2. Map of markets
```{r map2,echo=FALSE,warning=FALSE,message=FALSE}
...
3. Assign planting and harvest season months
```{r assign3,echo=FALSE,warning=FALSE,message=FALSE,results='hide'}
...
4. Calculate returns from min harvest to max "lean season" (3 months pre-harvest)
```{r harvest4,echo=FALSE,include=FALSE}
...
4.nom. Calculate returns from min harvest to max "lean season" (3 months pre-harvest) for nominal prices
```{r harvest4,echo=FALSE,include=FALSE}
...
5. Calculate intratemporal returns by varying the number of months after harvest end (only real)
```{r duration5,echo=FALSE,include=FALSE}
...
write_dta(returns_dur1,paste0("c:/Users/lilac2/Box/GIEWS_Project/GIEWS/Final/Data/Clean Data/returns_dur1_",format(Sys.Date(),"%d%m%y"),".dta"))
...
#rejoin the returns 
# returns_dur=full_join(returns_dur1,returns_dur2,by=c("country","region","market","commodity","market_type","year","month","price_real_kg","date"))%>%
...
names(print)<-header1
print(print,file=paste0("./retailprices_single_",format(Sys.Date(),"%m_%d_%y"),".tex"),include.rownames=FALSE)

print=xtable(retail12,type="latex")
names(print)<-header12
print(print,file=paste0("./retailprices_double_",format(Sys.Date(),"%m_%d_%y"),".tex"),include.rownames=FALSE)

print=xtable(wholesale1,type="latex")
names(print)<-header1
print(print,file=paste0("./wholesaleprices_single_",format(Sys.Date(),"%m_%d_%y"),".tex"),include.rownames=FALSE)

print=xtable(wholesale12,type="latex")
names(print)<-header12
print(print,file=paste0("./wholesaleprices_double_",format(Sys.Date(),"%m_%d_%y"),".tex"),include.rownames=FALSE)
...
# print(print,file=paste0("./retailprices_ltd_",format(Sys.Date(),"%m_%d_%y"),".tex"),include.rownames=FALSE)
...
7.nom. Print summary datasets (repeat for nominal)
```{r print7,echo=FALSE}
...
print=xtable(retail1,type="latex")
names(print)<-header1
print(print,file=paste0("./retailprices_single_nom",format(Sys.Date(),"%m_%d_%y"),".tex"),include.rownames=FALSE)

print=xtable(retail12,type="latex")
names(print)<-header12
print(print,file=paste0("./retailprices_double_nom",format(Sys.Date(),"%m_%d_%y"),".tex"),include.rownames=FALSE)

print=xtable(wholesale1,type="latex")
names(print)<-header1
print(print,file=paste0("./wholesaleprices_single_nom",format(Sys.Date(),"%m_%d_%y"),".tex"),include.rownames=FALSE)

print=xtable(wholesale12,type="latex")
names(print)<-header12
print(print,file=paste0("./wholesaleprices_double_nom",format(Sys.Date(),"%m_%d_%y"),".tex"),include.rownames=FALSE)
...
8. Data availability (real)
```{r missing8,echo=FALSE,include=FALSE}
...
print(print,file=paste0("C:/Users/lilac2/Box/GIEWS_Project/GIEWS/Final/Output/missingstats_single_retail_",format(Sys.Date(),"%m_%d_%y"),".tex"),include.rownames=FALSE)
...
names(print)<-c("Country","Commodity","Total Years","Total Markets","N markets 1+ years","N markets 5+ years")
print(print,file=paste0("C:/Users/lilac2/Box/GIEWS_Project/GIEWS/Final/Output/missingstats_single_wholesale_",format(Sys.Date(),"%m_%d_%y"),".tex"),include.rownames=FALSE)
...
print(print,file=paste0("C:/Users/lilac2/Box/GIEWS_Project/GIEWS/Final/Output/missingstats_double_retail_",format(Sys.Date(),"%m_%d_%y"),".tex"),include.rownames=FALSE)
...
names(print)<-c("Country","Commodity","Total Years","Total Markets","Main N markets 1+ years","Main N markets 5+ years","Second N markets 1+ years","Second N markets 5+ years")
print(print,file=paste0("C:/Users/lilac2/Box/GIEWS_Project/GIEWS/Final/Output/missingstats_double_wholesale_",format(Sys.Date(),"%m_%d_%y"),".tex"),include.rownames=FALSE)
...
print(print,file=paste0("C:/Users/lilac2/Box/GIEWS_Project/GIEWS/Final/Output/stats_all_",format(Sys.Date(),"%m_%d_%y"),".tex"),include.rownames=FALSE)
...
print(print,file=paste0("C:/Users/lilac2/Box/GIEWS_Project/GIEWS/Final/Output/missingness_single_",format(Sys.Date(),"%m_%d_%y"),".tex"),include.rownames=FALSE)
...
print(print,file=paste0("C:/Users/lilac2/Box/GIEWS_Project/GIEWS/Final/Output/missingness_double_",format(Sys.Date(),"%m_%d_%y"),".tex"),include.rownames=FALSE)
...
ggsave("missingness_single.PNG",width=12,height=9)
...
ggsave("missingness_double.PNG",width=12,height=9)
...
10. Output figure: Dot plot of frequency of negative returns vs severity of trend (average returns)
...
ggsave("seasondotplot_single.png")
...
ggsave("seasondotplot_double.png")
...
ggsave("cropyear_returns_dot_single_yield.PNG")
...
ggsave("cropyear_returns_dot_single_prod.PNG")
...
ggsave("cropyear_returns_dot_double_yield.PNG")
...
ggsave("harvestprices_returns_single.PNG",width=12,height=9)
...
ggsave("harvestprices_returns_double.PNG",width=12,height=9)
...
print(t,file=paste0("c:/Users/lilac2/Box/GIEWS_Project/GIEWS/Final/Output/OLSprobitreturns_single_",format(Sys.Date(),"%m_%d_%y"),".tex"),include.rownames=FALSE)
...
print(t_fe,file=paste0("c:/Users/lilac2/Box/GIEWS_Project/GIEWS/Final/Output/OLSprobitreturns_FE_single_",format(Sys.Date(),"%m_%d_%y"),".tex"),include.rownames=FALSE)
...
print(sim_table_grp,file=paste0("./nostore_riskgrp_",format(Sys.Date(),"%m_%d_%y"),".tex"),include.rownames=FALSE)

sim_table_grp=xtable(nostore_r0,auto=TRUE,type="latex")
print(sim_table_grp,file=paste0("./nostore_riskgrp_r",format(Sys.Date(),"%m_%d_%y"),".tex"),include.rownames=FALSE)

sim_table_grp=xtable(nostore_r5,auto=TRUE,type="latex")
print(sim_table_grp,file=paste0("./nostore_i5_riskgrp_",format(Sys.Date(),"%m_%d_%y"),".tex"),include.rownames=FALSE)

sim_table_grp=xtable(nostore_r10,auto=TRUE,type="latex")
print(sim_table_grp,file=paste0("./nostore_i10_riskgrp_",format(Sys.Date(),"%m_%d_%y"),".tex"),include.rownames=FALSE)

sim_table_grp=xtable(minr_nostore,auto=TRUE,type="latex")
print(sim_table_grp,file=paste0("./nostore_minr_riskgrp_",format(Sys.Date(),"%m_%d_%y"),".tex"),include.rownames=FALSE)
...
print(sim_table_grp,file=paste0("./nostore_riskgrp_nom_",format(Sys.Date(),"%m_%d_%y"),".tex"),include.rownames=FALSE)

sim_table_grp=xtable(nostore_r0n,auto=TRUE,type="latex")
print(sim_table_grp,file=paste0("./nostore_riskgrp_r_nom_",format(Sys.Date(),"%m_%d_%y"),".tex"),include.rownames=FALSE)

sim_table_grp=xtable(nostore_r5n,auto=TRUE,type="latex")
print(sim_table_grp,file=paste0("./nostore_i_riskgrp_nom",format(Sys.Date(),"%m_%d_%y"),".tex"),include.rownames=FALSE)
...
print(table_grp,file=paste0("c:/Users/lilac2/Box/GIEWS_Project/GIEWS/Final/Output/nostore_pred_i5",format(Sys.Date(),"%m_%d_%y"),".tex"),include.rownames=FALSE)
...
table_grp=xtable(nostore_r5,auto=TRUE,type="latex")
print(table_grp,file=paste0("c:/Users/lilac2/Box/GIEWS_Project/GIEWS/Final/Output/nostore_pred_nom_i5",format(Sys.Date(),"%m_%d_%y"),".tex"),include.rownames=FALSE)
...
ggsave("dur_returns_facet_single.PNG",width=12,height=9)
...
ggsave("dur_returns_facet_double.PNG",width=12,height=9)
...
ggsave("monavg_facet_single.PNG",width=12,height=9)
...
ggsave("monavg_facet_double.PNG",width=12,height=9)
...
ggsave("minmax_facet_single.PNG",width=12,height=9)
...
ggsave("minmax_facet_double.PNG",width=12,height=9)
